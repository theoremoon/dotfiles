...
function displayoptimize() {
  if xrandr | grep -q "HDMI-1 connected"; then
    xrandr --output HDMI-2 --off --output HDMI-1 --mode 1680x1050 --pos 0x0 --rotate normal --output DP-1 --off --output eDP-1 --primary --mode 1366x768 --pos 1680x0 --rotate normal --output DP-2 --off
